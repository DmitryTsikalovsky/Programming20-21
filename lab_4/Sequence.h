...
// написать сортировку выбором САМОСТОЯТЕЛЬНО  +
// сделать приватными внутренние функции (сделано) +
// посмотреть про итераторы -
// созавать копии данных для сортирови и передавать в лист и в масссив одинаково -
// ssh добавить (сделано) +



//сделать названия в едином стиле адекватные названия
//конст ссылки в компараторе
// проверить на более сложных типах
